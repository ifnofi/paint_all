...
public class Reporter : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        var enable = IniTool.GetValue("Reporter", "enable", PathTool.ConfigPath, "1");
        if (enable == "1")
        {
            transform.gameObject.SetActive(true);
            var str = IniTool.GetValue("Reporter", "show", PathTool.ConfigPath, "0");
            show = str == "1";
        }
        else
        {
    ...
    void drawToolBar()
    {
        ...
        if (showClearOnNewSceneLoadedButton && GUILayout.Button(clearOnNewSceneContent, (clearOnNewSceneLoaded) ? buttonActiveStyle : barStyle, GUILayout.Width(size.x * 2),

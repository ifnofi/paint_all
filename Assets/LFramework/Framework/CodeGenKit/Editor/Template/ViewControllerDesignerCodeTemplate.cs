        ...
        public static void Generate(CodeGenTask task)
        {
            ...
            root.Namespace(namespaceName,
                (ns) =>
                {
                    ...
                    var parentClassName = hasArchitecture ? "LFramework.IController" : "";
                    ns.Class(task.ClassName,parentClassName , true, false, cs =>
                    {
                        ...
                        {
                            cs.Custom(
                                $"LFramework.IArchitecture LFramework.IBelongToArchitecture.GetArchitecture()=>{viewController.ArchitectureFullTypeName}.Interface;");
                        }
                    });
                });

...
namespace LFramework
{
    ...
    {
        [MenuItem("GameObject/LFramework/CodeGenKit/@(Alt+V)Add View Controller &v", false, 0)]
        static void AddView()
        {
        ...
        [MenuItem("GameObject/LFramework/CodeGenKit/@(Alt+B)Add Bind &b", false, 1)]
        ...
        [MenuItem("GameObject/LFramework/CodeGenKit/@(Alt+C)Create Code &c", false, 2)]
        ...
        private void OnEnable()
        {
            ...
            mViewControllerTypeMenus = mViewControllerTypes.Select(t => t.FullName).Append("LFramework.ViewController").ToArray();
        ...
        private static Type[] SearchAllArchitectureTypes()
        {
            ...
            return AppDomain.CurrentDomain.GetAssemblies().Where(a => !a.FullName.Contains("UnityEngine") && !a.FullName.Contains("Kit") && !a.FullName.Contains("LFramework"))

...
namespace SRF.Service
{
    ...
    public class SRServiceManager : SRAutoSingleton<SRServiceManager>
    {
        ...
        protected void UpdateStubs()
        {
            ...
            this._serviceStubs = new List<ServiceStub>();
            ...
            {
                var serviceStrings =
                    this._serviceStubs.Select(p => "	{0}".Fmt(p)).ToArray();
        ...
        protected object AutoCreateService(Type t)
        {
            ...
            foreach (var stub in this._serviceStubs)
            {
        ...
        protected void OnDisable()
        {
            ...
            {
                var disposable = s.Object as IDisposable;
                if (disposable != null)
                {
                    disposable.Dispose();
                }

                var behaviour = s.Object as Behaviour;
                if (behaviour != null)
                {
            ...
            this._services.Clear(clean: true);
        }
#endif
        ...
        private void ScanType(Type type)
        {
            ...
            if (attribute != null)
            {
                this._serviceStubs.Add(new ServiceStub
                {
                    Type = type,
            ...
            ScanTypeForConstructors(type, this._serviceStubs);
            ScanTypeForSelectors(type, this._serviceStubs);
        }

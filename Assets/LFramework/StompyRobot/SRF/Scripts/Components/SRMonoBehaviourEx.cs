...
namespace SRF
{
    ...
    public sealed class RequiredFieldAttribute : Attribute
    {
        ...
        {
            get { return this._autoSearch; }
            set { this._autoSearch = value; }
        }
        ...
        {
            get { return this._editorOnly; }
            set { this._editorOnly = value; }
        }
    }
    ...
    public abstract class SRMonoBehaviourEx : SRMonoBehaviour
    {
        ...
        private static void CheckFields(SRMonoBehaviourEx instance, bool justSet = false)
        {
            ...
            if (!_checkedFields.TryGetValue(instance.GetType(), out var cache))
            {
                cache = ScanType(t);

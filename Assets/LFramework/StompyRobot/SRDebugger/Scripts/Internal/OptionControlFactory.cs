namespace SRDebugger.Internal
{
    ...
    public static class OptionControlFactory
    {
        ...
        {
            var type = new OptionType(@from.Property.PropertyType, !@from.Property.CanWrite);

            if (!TypeCache.TryGetValue(type, out var control))
            {
        ...
        private struct OptionType
        {
            ...
            {
                return Equals(this.Type, other.Type) && this.IsReadyOnly == other.IsReadyOnly;
            }

            public override bool Equals(object obj)
            {
                return obj is OptionType other && this.Equals(other);
            }
            ...
            public override int GetHashCode()
            {
                unchecked
                {
                    return ((this.Type != null ? this.Type.GetHashCode() : 0) * 397) ^ this.IsReadyOnly.GetHashCode();
                }
            }
        }
    }

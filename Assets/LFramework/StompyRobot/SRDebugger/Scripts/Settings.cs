...
#pragma warning disable 0649
    ...
    public class Settings : ScriptableObject
    {
        ...
        {
            if (this._keyboardShortcuts == null || this._keyboardShortcuts.Length == 0)
            {
            ...
            for (var i = 0; i < this._keyboardShortcuts.Length; i++)
            {
                var s = this._keyboardShortcuts[i];
            ...
            this._newKeyboardShortcuts = newShortcuts.ToArray();
        ...
        {
            get { return this._uiInputMode; }
#if UNITY_EDITOR
            set { this._uiInputMode = value; }
#endif
        }

        public DefaultTabs DefaultTab
        {
            get { return this._defaultTab; }
#if UNITY_EDITOR
        ...
        {
            get { return this._triggerEnableMode; }
#if UNITY_EDITOR
            set { this._triggerEnableMode = value; }
#endif
        }
        ...
        {
            get { return this._triggerBehaviour; }
#if UNITY_EDITOR
            set { this._triggerBehaviour = value; }
#endif
        }
        ...
        {
            get { return this._errorNotification; }
#if UNITY_EDITOR
            set { this._errorNotification = value; }
#endif
        }

        public bool EnableKeyboardShortcuts
        {
            get { return this._enableKeyboardShortcuts; }
#if UNITY_EDITOR
        ...
        {
            get { return this._newKeyboardShortcuts; }
#if UNITY_EDITOR
            set { this._newKeyboardShortcuts = value.ToArray(); }
#endif
        }

        public bool KeyboardEscapeClose
        {
            get { return this._keyboardEscapeClose; }
#if UNITY_EDITOR
        ...
        {
            get { return this._enableBackgroundTransparency; }
#if UNITY_EDITOR
            set { this._enableBackgroundTransparency = value; }
#endif
        }

        public float BackgroundTransparency
        {
            get { return this._backgroundTransparency; }
#if UNITY_EDITOR
            set { this._backgroundTransparency = value; }
#endif
        }

        public bool RequireCode
        {
            get { return this._requireEntryCode; }
#if UNITY_EDITOR
            set { this._requireEntryCode = value; }
#endif
        }

        public bool RequireEntryCodeEveryTime
        {
            get { return this._requireEntryCodeEveryTime; }
#if UNITY_EDITOR
            set { this._requireEntryCodeEveryTime = value; }
#endif
        }

        public IList<int> EntryCode
        {
            get { return new ReadOnlyCollection<int>(this._entryCode); }
            set
            {
                if (value.Count != 4)
                {
                ...
                this._entryCode = value.ToArray();
            }
        }

        public bool UseDebugCamera
        {
            get { return this._useDebugCamera; }
#if UNITY_EDITOR
            set { this._useDebugCamera = value; }
#endif
        }

        public int DebugLayer
        {
            get { return this._debugLayer; }
#if UNITY_EDITOR
            set { this._debugLayer = value; }
#endif
        }

        public float DebugCameraDepth
        {
            get { return this._debugCameraDepth; }
#if UNITY_EDITOR
            set { this._debugCameraDepth = value; }
#endif
        }

        public bool CollapseDuplicateLogEntries
        {
            get { return this._collapseDuplicateLogEntries; }
#if UNITY_EDITOR
        ...
        {
            get { return this._richTextInConsole; }
#if UNITY_EDITOR
            set { this._richTextInConsole = value; }
#endif
        }
        ...
        {
            get { return this._enableBugReporter; }
#if UNITY_EDITOR
            set { this._enableBugReporter = value; }
#endif
        }

        public bool EnableBugReportScreenshot
        {
            get { return this._enableBugReportScreenshot; }
#if UNITY_EDITOR
            set { this._enableBugReportScreenshot = value; }
#endif
        }

        public IList<DefaultTabs> DisabledTabs
        {
            get { return this._disabledTabs; }
#if UNITY_EDITOR
            set { this._disabledTabs = value.ToArray(); }
#endif
        }
        ...
        {
            get { return this._triggerPosition; }
#if UNITY_EDITOR
            set
            {
                var prevValue = this._triggerPosition;
                this._triggerPosition = value;
                if (this.OptionsAlignment == value)
                {
                    this.OptionsAlignment = prevValue;
                }
                if (this.ProfilerAlignment == value)
                {
                    this.ProfilerAlignment = prevValue;
                }
            }
#endif
        }
        ...
        {
            get { return this._profilerAlignment; }
#if UNITY_EDITOR
            set
            {
                ...
                {
                    // Prefer bottom left
                    if (this.TriggerPosition != PinAlignment.BottomLeft && this.OptionsAlignment != PinAlignment.BottomLeft)
                    {
                    ...
                    for (var i = 0; i < 4; i++)
                    {
                        ...
                        if (this._triggerPosition == pin || this._optionsAlignment == pin)
                            continue;

                        this._profilerAlignment = pin;
                        return;
                    }
                ...
                var prevValue = this._profilerAlignment;
                this._profilerAlignment = value;

                if (this.TriggerPosition == value)
                {
                    this.TriggerPosition = prevValue;
                }
                if (this.OptionsAlignment == value)
                {
                    this.OptionsAlignment = prevValue;
        ...
        {
            get { return this._optionsAlignment; }
#if UNITY_EDITOR
            set
            {
                ...
                {
                    // Prefer bottom right
                    if (this.TriggerPosition != PinAlignment.BottomRight && this.ProfilerAlignment != PinAlignment.BottomRight)
                    {
                        this._optionsAlignment = PinAlignment.BottomRight;
                        return;
                    }
                    for (var i = 0; i < 4; i++)
                    {
                        var pin = (PinAlignment)i;
                        if (this._triggerPosition == pin || this._profilerAlignment == pin)
                            continue;

                        this._optionsAlignment = pin;
                        return;
                    }
                ...
                var prevValue = this._optionsAlignment;
                this._optionsAlignment = value;
        ...
        {
            get { return this._consoleAlignment; }
            set { this._consoleAlignment = value; }
        }

        public int MaximumConsoleEntries
        {
            get { return this._maximumConsoleEntries; }
            set { this._maximumConsoleEntries = value; }
        }

        public bool EnableEventSystemGeneration
        {
            get { return this._enableEventSystemCreation; }
            set { this._enableEventSystemCreation = value; }
        }

        public bool AutomaticallyShowCursor
        {
            get { return this._automaticShowCursor; }
#if UNITY_EDITOR
            set { this._automaticShowCursor = value; }
#endif
        }

        public float UIScale
        {
            get { return this._uiScale; }
            set
            {
                if (value == this._uiScale) return;
                this._uiScale = value;
                this.OnPropertyChanged("UIScale");
            }
        }

        public bool UnloadOnClose
        {
            get { return this._unloadOnClose; }
#if UNITY_EDITOR
            set
            {
                this._unloadOnClose = value;
            }
#endif
        }
        ...
        {
            get { return this._disableWelcomePopup; }
            set { this._disableWelcomePopup = value; }
        }
#endif

...
namespace SRDebugger.Editor
{
    ...
    internal class WelcomeWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            SRInternalEditorUtil.DrawFooterLayout(this.position.width - 15);
        ...
        {
            if (this._demoSprite == null)
            {
                this._demoSprite = SRInternalEditorUtil.LoadResource<Texture2D>("Editor/DemoSprite.png");
            }
            ...
            SRInternalEditorUtil.RenderGif(rect, this._demoSprite, actualFrame, frameWidth, frameHeight, 5, framePadding,
                framePadding);

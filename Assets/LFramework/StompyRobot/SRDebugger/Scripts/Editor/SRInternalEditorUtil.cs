...
namespace SRDebugger.Editor
{
    ...
    internal static class SRInternalEditorUtil
    {
        ...
        public static class EditorSettings
        {
            ...
            public static SettingsResult TryGetOrCreate(out Settings instance, out string message)
            {
                ...
                try
                {
                    var result = InternalTryGetOrCreateSettings(out _instance, out message);
                    instance = _instance;
                    return result;
                }
                catch (Exception e)
            ...
            private static SettingsResult InternalTryGetOrCreateSettings(out Settings instance, out string message)
            {
                ...
                var disabledSettingsFile = SRInternalEditorUtil.GetAssetPath(DisabledSettingsFilePath);
                ...
                var containingDirectory = Path.GetDirectoryName(settingsAssetPath);

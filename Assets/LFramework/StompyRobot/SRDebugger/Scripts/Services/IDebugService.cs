...
namespace SRDebugger
{
    ...
    public struct EntryCode : IReadOnlyList<int>
    {
        ...
        {
            return new List<int> { this.Digit1, this.Digit2, this.Digit3, this.Digit4 }.GetEnumerator();
        }
        ...
        public int this[int index]
        {
            get
            {
                switch (index)
                {
                    case 0: return this.Digit1;
                    case 1: return this.Digit2;
                    case 2: return this.Digit3;
                    case 3: return this.Digit4;

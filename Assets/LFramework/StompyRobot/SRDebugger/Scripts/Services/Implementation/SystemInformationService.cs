namespace SRDebugger.Services.Implementation
{
    ...
    public class StandardSystemInformationService : ISystemInformationService
    {
        ...
        public IList<InfoEntry> GetInfo(string category)
        {
            ...
            if (!this._info.TryGetValue(category, out var list))
            {
        ...
        {
            var dict = new Dictionary<string, Dictionary<string, object>>(this._info.Count);

            foreach (var keyValuePair in this._info)
            {
        ...
        private void CreateDefaultSet()
        {
            ...
            if (manifestDict != null)
            {
                ...
                this._info.Add("Build", manifestList);
            }

            this._info.Add("Features", new[]
            {
...
#pragma warning disable 618
            this._info.Add("Graphics - Device", new[]
            {
            ...
            this._info.Add("Graphics - Features", new[]
            {

...
public class BoyAnimeMgr : SerializedMonoBehaviour
{
    ...
    public void StartMove(Action callback = null)
    {
        ...
        moveCoroutine = StartCoroutine(DoMove3Init(callback));
    }
    ...
    public void StopMove()
    {
        ...
        // moveImg.GetComponent<CanvasGroup>().DOFade(0, 1).SetEase(Ease.Linear);
        // boyAnimator.Play("Idle", 0);
    }

    private Coroutine moveCoroutine;

    private IEnumerator DoMove3Init(Action callback = null)
    {
        sequence.Kill();
        sequence = DOTween.Sequence();

...
public class MountController : BaseController
{
    ...
    public override void StopButWaitTimePlayAnim(int waitTime)
    {
        ...
        actionController = ActionKit.Sequence()
           .Callback(Talk)
           .Delay(waitTime)
           .Callback(Walk)
           .Start(this);
    ...
    public override void StopButWaitTimePlayAnim(int waitTime, float waitToPlayAnimTime)
    {
        if (actionController != null)
        {
            actionController.Deinit();
        ...
        actionController = ActionKit.Sequence()
           .Callback(Talk)
           .Delay(waitToPlayAnimTime)
           .Callback(Talk1)
           .Delay(waitTime - waitToPlayAnimTime)
           .Callback(Walk)
           .Start(this);
    }
